    ...
    sections: {
        ...
        aboutMe: `
            <p style="margin-bottom: 1rem;">
              Hi! I'm Allan, a <strong>full-stack developer</strong> specializing in building <strong>responsive websites</strong>, engaging blogs, e-commerce solutions, and interactive streaming platforms. I focus on crafting <strong>clean and efficient code</strong>, from polished front-end designs to robust back-end systems.
            </p>
            <p style="margin-bottom: 1rem;">
        ...
        projects: [
            ...
            },
            {
                ...
                link: "https://resume-maker-theta-three.vercel.app/",
                previewImages: [
            ...
            {
                title: "Allan Kiplagat| Portfolio Website",
                description:
                    "This is my portfolio website. I built it to showcase my projects and skills. It is a static site built with Next.js, Tailwind CSS, and Shadcn/UI. I used the following technologies to build it:",
                logo: "/projects/portfolio/portfolio-logo.webp",
